...
QtObject {
    ...
    function query(kind) {
        const allowed = ["brightness", "clipboard", "images", "notifications"];
    ...
    function action(name, argument) {
        ...
        const noArgument = ["brightness-down", "brightness-up", "lock", "logout", "notification-clear", "poweroff", "reboot", "suspend"];
        const numericArgument = ["brightness-set", "clipboard-copy", "notification-invoke"];
